...
import com.crypto.core.ui.composables.LoadingState.Finished
import com.crypto.core.ui.composables.LoadingState.Loading
...
class WebViewNavigator(private val coroutineScope: CoroutineScope) {
  ...
  internal suspend fun WebView.handleNavigationEvents(): Unit = withContext(Dispatchers.Main) {
