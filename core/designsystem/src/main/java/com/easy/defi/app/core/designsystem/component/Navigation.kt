 ...
 */
@Composable
fun RowScope.DeFiNavigationBarItem(
  selected: Boolean,
  onClick: () -> Unit,
  ...
  NavigationBarItem(
    ...
    colors = NavigationBarItemDefaults.colors(
      selectedIconColor = DeFiNavigationDefaults.navigationSelectedItemColor(),
